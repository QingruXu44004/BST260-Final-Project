...
Speechiness, acousticness, and danceability have Gini indeces above 2000 and show relatively higher variable importances than the other three variables. So random forest with only these three vairbles is fitted below to see if there is any improvement in performance: 
...
Since the overall accuracy dropped from 0.717 to 0.646, we will still stick with the models with all 6 variables. 
